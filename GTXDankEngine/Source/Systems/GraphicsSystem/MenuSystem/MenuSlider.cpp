...
void MenuSlider::Draw()
{
    ...
    engine.GraphicsSys.DrawCustomText(name.c_str(), (sldrHeight+5) / 100.0f, glm::vec2(xSliderPos-sldrWidth/2.0f, engine.GraphicsSys.camera.height - (yCommonPos+sldrHeight)), glm::vec3(1));
