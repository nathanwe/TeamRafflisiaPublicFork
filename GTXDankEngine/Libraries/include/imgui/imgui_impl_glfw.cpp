...
#define MAP_ANALOG(NAV_NO, AXIS_NO, V0, V1) { float v = (axes_count > AXIS_NO) ? axes[AXIS_NO] : V0; v = (v - V0) / (V1 - V0); if (v > 1.0f) v = 1.0f; if (io.NavInputs[NAV_NO] < v) io.NavInputs[NAV_NO] = v; }
        ...
        // TODO
        MAP_ANALOG(ImGuiNavInput_DpadLeft, 0, -0.3f, -0.9f);
        MAP_ANALOG(ImGuiNavInput_DpadRight, 0, +0.3f, +0.9f);
        MAP_ANALOG(ImGuiNavInput_DpadUp, 1, -0.3f, -0.9f);
        MAP_ANALOG(ImGuiNavInput_DpadDown, 1, +0.3f, +0.9f);
#undef MAP_BUTTON
#undef MAP_ANALOG
...
#define MAP_KEY(NAV_NO, KEY_NO) { if (io.KeysDown[KEY_NO]) io.NavInputs[NAV_NO] = 1.0f; }
            ...
            MAP_KEY(ImGuiNavInput_Cancel, GLFW_KEY_ESCAPE);
            MAP_KEY(ImGuiNavInput_Menu, GLFW_KEY_LEFT_ALT);
            MAP_KEY(ImGuiNavInput_Input, GLFW_KEY_ENTER);
            MAP_KEY(ImGuiNavInput_DpadUp, GLFW_KEY_UP);
            MAP_KEY(ImGuiNavInput_DpadDown, GLFW_KEY_DOWN);
            MAP_KEY(ImGuiNavInput_DpadLeft, GLFW_KEY_LEFT);
            MAP_KEY(ImGuiNavInput_DpadRight, GLFW_KEY_RIGHT);
            /*
